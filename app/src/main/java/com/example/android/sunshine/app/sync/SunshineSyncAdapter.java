...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    //TODO dejar la notificacion 1 al día
//    private static final long DAY_IN_MILLIS = 1000 * 60 * 60 * 24;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String FORECAST_BASE_URL =
                    "http://api.openweathermap.org/data/2.5/forecast/daily?appid=2a0a68b100a5be9504c8ccd3e25bff9d";
    ...
    private void notifyWeather() {
        ...
        if(Utility.isNotificationsActive(getContext())) {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                // delete old data so we don't build an endless history
