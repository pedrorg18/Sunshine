...
public class ForecastAdapter extends CursorAdapter {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String highLowStr = com.example.android.sunshine.app.Utility.formatTemperature(mContext, high, isMetric) + "/" + com.example.android.sunshine.app.Utility.formatTemperature(mContext, low, isMetric);
        return highLowStr;
    }
